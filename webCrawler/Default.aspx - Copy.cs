...
";
        ...
        Response.Write(crawlImage("http://supersonicart.com/post/92549394632/photoset_iframe/supersonicart/tumblr_n94ksd8giU1qz9v0t/0/false", "crawlPic"));
    }//end pageload
    /*
    ...
    */
    ...
    public string crawlImage(string thisURL, string imgClass)
    {
        ...
        string thisHTML = GetWebText(thisURL);
        //Response.Write(thisHTML.Length + "<br />");//.Substring(1500));

        //straddling image below
        //http://31.media.tumblr.com/93dc4dd501e84ed6d66f0cdb80d1e274/tumblr_n94ksd8giU1qz9v0to4_500.jpg
        //hmm...
        //id="photoset_iframe_92549394632" class="photoset" scrolling="no" frameborder="0" height="-10" width="100%" style="border:0px; background-color:transparent; overflow:hidden;" src="http://supersonicart.com/post/92549394632/photoset_iframe/supersonicart/tumblr_n94ksd8giU1qz9v0t/0/false">
        //iframe id="photoset_iframe_92549394632" class="photoset" scrolling="no" frameborder="0" height="-10" width="100%" style="border:0px; background-color:transparent; overflow:hidden;" src="http://supersonicart.com/post/92549394632/photoset_iframe/supersonicart/tumblr_n94ksd8giU1qz9v0t/0/false">
        //Response.Write(thisHTML.Substring(58694) + "<br />");
        //Response.Write(thisHTML.Substring(58694, 1000) + "<br />");
        //end straddle

        string[] splitThis = thisHTML.Split('\n');
        //string[] splitThis = thisHTML.Substring(58693, 1000).Split('\n');
        ...
        for (int i = 0; i < splitThis.Length - 1; i++)
        {
            ...
            if (splitThis[i].Length > dilm)
            {
                ...
                //Response.Write(splitThis[i].Substring(dilm) + "<br />");
           
                //Response.Write(splitThis[i] + "...<br />");

            /**********************
                //Response.Write("<br />" + splitThis[i].Substring() + "<br />");
                ...
                if (jpi.getStringBetween(splitThis[i], txtA, 6, txtB).Length > 0)
                {
                    ...
                    //Response.Write("<br />" + splitThis[i] + "<br />");
                    //Response.Write("<br />." + jpi.getStringBetween(splitThis[i], "href=\"", 6, "\"") + ".<br />");
    ...
    public string crawl_Iframe_image()
    {
        return "";
